import monsterTypeList from '@/render/assets/json/monster-type-list.json';
import { characterToHalf, kanjiToKana, numberToFull, numberToHalf } from '@/render/views/yugioh/yugioh';
