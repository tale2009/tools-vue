...
<script>
  ...
  import PayDialog from '@/render/views/account/buy/components/PayDialog';
  import alipay from '@/render/assets/image/alipay.png';
  import wxpay from '@/render/assets/image/wxpay.png';
