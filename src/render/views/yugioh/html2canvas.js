...
var CanvasRenderer = /** @class */ (function (_super) {
  ...
  CanvasRenderer.prototype.renderTextNode = function (text, styles, container) {
    return __awaiter(this, void 0, void 0, function () {
      var _a, font, fontFamily, fontSize, _b, baseline, middle, paintOrder, lineLength, x0, x1, x, y0, y1, y, canvas, xctx, gradient_1;
      var _this = this;
      ...
      return __generator(this, function (_c) {
        ...
        text.textBounds.forEach(function (text) {
          ...
          // console.log("backgroundClip not 3");
              ...
              :
                if (styles.backgroundClip[0] == 3) {
                  if (styles.backgroundImage[0] === undefined) {
                    ...
                    _b = calculateGradientDirection(styles.backgroundImage[0].angle, adorWidth, adorHeight), lineLength = _b[0], x0 = _b[1], x1 = _b[2], y0 = _b[3], y1 = _b[4];
                    canvas = document.createElement('canvas');
                    canvas.width = adorWidth;
                    canvas.height = adorHeight;
                    xctx = canvas.getContext('2d');
        ...
        switch (_b.label) {
          case 0:
            ...
            _loop_1 = function (backgroundImage) {
              var image, url, _c, path, x, y, width, height, pattern, _d, path, x, y, width, height, _e, lineLength, x0, x1, y0, y1, canvas, ctx, gradient_1, pattern, _f, path,
                left, top_1, width, height, position, x, y, _g, rx, ry, radialGradient_1, midX, midY, f, invF;
  ...
  CanvasRenderer.prototype.renderDashedDottedBorder = function (color, width, side, curvePoints, style) {
    return __awaiter(this, void 0, void 0, function () {
      var strokePaths, boxPaths, startX, startY, endX, endY, length, dashLength, spaceLength, useLineDash, multiplier, numberOfDashes, minSpace, maxSpace, path1, path2, path1,
        path2;
      return __generator(this, function (_a) {
        this.ctx.save();
