...
<script>
  ...
  import SearchPage from '@/render/components/page/SearchPage';
  ...
  import CardDialog from '@/render/views/my-cards/components/CardDialog';
  import CommentList from '@/render/components/CommentList';
