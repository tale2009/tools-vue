<template>
  <div class="app-header-container">
    ...
    <p v-if="!isElectron" style="color:red;">网站将于2022-12-25下线关闭，请相互通知</p>
...
<script>
  ...
  import SignAvatar from '@/render/layout/app-layout/components/SignAvatar';
  import QADialog from '@/render/components/dialog/QADialog';
  import AboutDialog from '@/render/components/dialog/AboutDialog';
  import ThankDialog from '@/render/components/dialog/ThankDialog';
  ...
  export default {
    ...
    computed: {
      ...mapState(['leftCollapse', 'rightCollapse', 'bodyOffsetWidth', 'isSmallScreen', 'isElectron']),
